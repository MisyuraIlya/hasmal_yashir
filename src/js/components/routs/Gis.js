...
class AddPoint extends Component {
	...
	saveAdress(){
		...
		$.ajax({
			url: globalServer + 'new-api/polygon_add.php',
			type: 'POST',
			data: val
		}).done(function(data) {
...
export default class Gis extends Component {
	...
	editItems(Id, paramName, e){
		...
		$.ajax({
			url: globalServer + 'new-api/polygon_edit.php',
			type: 'POST',
			data: val
	...
	render(){
		return (
			<div className="page gis">
				...
				<h1 className="title">מערכת מידע גאוגרפית</h1>
