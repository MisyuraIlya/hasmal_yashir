...
//
global.entry = 'https://hashmal.statos.co.il';
global.globalServer = 'https://hashmal.statos.co.il/app/';
global.globalFileServer = 'https://hashmal.statos.co.il/src/img/';


// global.entry = 'http://localhost:8888/medi_b2b';
// global.globalServer = 'http://localhost:8888/medi_b2b/app/';
// global.globalFileServer = 'http://localhost:8888/medi_b2b/src/img/';


global.globalSiteName = "חשמל ישיר";
global.globalAdminMail = "statosbiz@statos.co";//falkon1@bezeqint.net
global.globalSiteUrl = "hashmal";
global.$ = require("jquery");


global.nDate = () => { return new Date().toLocaleTimeString('he-Il', { hour: 'numeric', minute: 'numeric', second: 'numeric'}).split(':').join('') };
let ua = navigator.userAgent.toLowerCase();
global.isAndroid = ua.indexOf("android") > -1;
global.jic = {
